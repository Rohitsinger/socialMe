...
// }
  return (
    <div className='mt-20 '  style={{margin:"10px auto", marginTop:"70px", maxWidth:"500px", padding:"20px", textAlign:"center"}}>
    ...
    <button className="waves-effect waves-dark btn" onClick={postDetails}>Create</button>
    </div>
  )
}
